...
if __name__ == "__main__":
    ...
    print("✅ ASR endpoint exists (405 = Method Not Allowed for HEAD)")
    print("❌ Sandbox might be slow")
    print("=" * 60)
    ...
    while True:
        ...
        if transcription:
            ...
            easygui.msgbox("Transcription failed. Check console for details.", "Error")
